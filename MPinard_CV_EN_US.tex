...
\quote{Computer enthusiast, I recently graduated and am looking for a job as a \Cpp{} developer\\ for early April 2020}
...
\begin{document}
	...
	\section{Computer skills}
		\cvline{Languages}{\Cpp{}, C, Java, \LaTeX{}/Ti\textit{k}Z, Python, Bash, CUDA, SQL, HTML/CSS, Assembly, VBA\ldots}
	...
	\section{Projects}
		...
		\subsection{Research}
			\cvitemcom{Hyperplanes calculator in dimension 4 finite geometries, (performance oriented) [\Cpp{}]}
				{\href{https://github.com/Lomadriel/HyperplaneFinder}{HyperplaneFinder}}
			\cvitem{}{~~~> \textit{publication \cite{Boulmier2019}}}
		\subsection{Internship}
			\cvitemcom{Program for solving the Set Cover Problem [\Cpp{}, dynamic\_bitset, spglog, json, cxxopts]}
				{\href{https://github.com/pinam45/UTBM_ST50_Rapport_de_stage_IRIMAS/releases/latest}{Internship report (fr)}}
			\cvitemcom{Program for processing Set Cover Problem results [\Cpp{}, spglog, json, cxxopts, inja]}
				{\href{https://github.com/pinam45/UTBM_ST50_Rapport_de_stage_IRIMAS/releases/latest}{Internship report (fr)}}

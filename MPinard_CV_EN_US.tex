...
\firstname{Maxime}
\familyname{Pinard}
\title{Currently 3rd year student in a Computer Science and Engineering program leading to an engineer degree, I'm looking for a 6 month internship as assistant engineer for September 2017}
...
%-------------------------------------------
  ...
  \vspace*{\deletedSpace}
	\section{Languages}
		...
		\cvdoubleitem{\bfseries English}{\cvskill{}{4} B2 {\footnotesize (BULATS 68)}, Professional working level}{\bfseries Japanese}{\cvskill{}{2} A2, Basic level}
...
%-------------------------------------------
  ...
  \vspace*{\deletedSpace}
	\section{Interests}
		...
		\cvline{Science}{Mathematics, theoretical physics, quantum physics\ldots}

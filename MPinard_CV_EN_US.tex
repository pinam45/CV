\PassOptionsToPackage{citecolor=green}{hyperref}
...
\begin{document}
	...
	\section{Computer skills}
		\cvline{Languages}{C++, C, Java 8 (SE et EE), \LaTeX{}/Ti\textit{k}Z, Python, Bash, CUDA, SQL, HTML/CSS, Assembly, VBA\ldots}
		\cvline{Tools}{UML, git, Maven, CMake, Make, Regex}
	...
	\section{Work experiences}
		...
		\tllabelcventry{2017/8}{2018/1}{08/2017 - 01/2018}
			...
			{Bruz, France}
			{Development and testing of an internal disassembly module}
			{}
	...
	\section{Projets}
		...
		\subsection{Internship}
			...
			\cvitemcom{Assembly / disassembly module for MIPS processors assembly code [C, Capstone, Keystone]}

...
\firstname{Maxime}
\familyname{Pinard}
\title{Intern as assistant engineer}
...
\quote{3rd year student in a program leading to an computer science engineer degree, I am looking for a 6 month internship in development for September 2017}
...
%-------------------------------------------
  ...
  \section{Computer skills}
    \cvline{Languages}{C++, Java 8 (SE and EE), C\#, \LaTeX, SARL, Bash, CUDA, SQL, HTML/CSS, Assembly, VBA\ldots}
    ...
    \cvline{Softwares}{Unity (+ package Vuforia AR and SteamVR for HTC Vive)}
...
%-------------------------------------------
  ...
  \vspace*{\deletedSpace}
	\section{Work experience}
		\tllabelcventry{2016/2}{2016/2}{Feb. 2016}{Animator}{JAB France, 1 week}{Evolène, Switzerland}{Camp of 40 young people, team of 15 animators}{}
    \vspace*{-1.9mm}
		\tllabelcventry{2015/2}{2015/3}{Jan.--Feb. 2015}{Animator}{JAB France, 1 week}{Contamines, France}{Camp of 50 young people, team of 20 animators}{}
    \vspace*{-1.9mm}

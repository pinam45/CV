...
\begin{document}
	...
	\section{Computer skills}
		...
		\cvline{Metaheuristics}{Tabu search, simulated annealing, genetic algorithms, ant colony optimization algorithms}
		\cvline{Libraries}{boost, fmt, spdlog, OpenGL, OpenCV, OpenMP, MPI, GTest, Catch2, Capstone, Keystone, Json, SFML, ImGui, GLFW, GLM, libmpg123, JavaFx, JUnit4}

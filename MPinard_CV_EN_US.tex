...
\begin{document}
	...
	\section{Computer skills}
		...
		\cvline{Libraries}{boost, fmt, spdlog, OpenGL, OpenCV, OpenMP, MPI, GTest, Catch2, Capstone, Keystone, Json, SFML, ImGui, GLFW, GLM, libmpg123, TagLib, cxxopts, inja, JavaFx, JUnit4}
	...
	\section{Projects}
		\subsection{Personal}
			\cvitemcom{Header-only dynamic bitset implementation and unit tests [C++, Catch2]}
			...
			\cvitemcom{Utility functions to configure C/C++ projects (clang-format, ccache, sanitizers,\ldots) [CMake]}
		...
		\subsection{School}
			\cvitemcom{Algorithms for solving the Set Cover Problem [C++, spdlog, dynamic\_bitset]}

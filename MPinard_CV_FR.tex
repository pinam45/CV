...
% fonts
\renewcommand*{\namefont}{\fontsize{42}{48}\mdseries\upshape}
...
\firstname{Maxime}
\familyname{Pinard}
\title{Élève-ingénieur informatique en 1ème année (\textit{BAC+3}), je cherche un stage de développement de 6 mois pour septembre 2017}
...
%-------------------------------------------
  ...
  \vspace*{\deletedSpace}
	\section{Langues}
		...
		\cvdoubleitem{\bfseries Anglais}{\cvskill{}{4} B2 (BULATS 68), usage professionnel}{\bfseries Japonais}{\cvskill{}{2} A2, élémentaire}
...
%-------------------------------------------
  ...
  \vspace*{\deletedSpace}
	\section{Centres d'intérêts}
		...
		\cvline{Les sciences}{Les mathématiques, la physique théorique, la physique quantique\ldots}

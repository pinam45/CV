...
\begin{document}
	...
	\section{Projets}
		\subsection{Personnels}
			\cvitemcom{Implémentation header-only d'un dynamic bitset et de ces test unitaires [C++, Catch2]}
			...
			\cvitemcom{Fonctions d'aide a la configuration des projets C/C++ (clang-format, ccache, sanitizers,\ldots) [CMake]}
		...
		\subsection{École}
			\cvitemcom{Algorithmes pour la résolution du Set Cover Problem [C++, spdlog, dynamic\_bitset]}

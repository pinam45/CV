...
%-------------------------------------------
  ...
  \section{Compétences informatiques}
    \cvline{Langages}{C++, Java 8 (SE et EE), C\#, \LaTeX, SARL, Bash, CUDA, SQL, HTML/CSS, Assembleur, VBA\ldots}
...
%-------------------------------------------
  ...
  \vspace*{\deletedSpace}
	\section{Centres d'intérêts}
		...
		\cvline{Le sport}{Le ski et les sports d'hivers, le vélo (VTT club pendant 3 ans), la marche en montagne}

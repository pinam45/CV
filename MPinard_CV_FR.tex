...
\quote{Passionné d'informatique et récemment diplômé, je cherche un travail en tant que\\ développeur \Cpp{} pour début avril 2020}
...
\begin{document}
	...
	\section{Compétences informatiques}
		\cvline{Langages}{\Cpp{}, C, Java, \LaTeX{}/Ti\textit{k}Z, Python, Bash, CUDA, SQL, HTML/CSS, Assembleur, VBA\ldots}
		...
		\cvline{Bibliothèques}{boost, fmt, spdlog, OpenGL, OpenCV, OpenMP, MPI, GTest, Catch2, Capstone, Keystone, Json, SFML, ImGui, GLFW, GLM, libmpg123, TagLib, cxxopts, inja, JavaFx, JUnit4}
	...
	\section{Projets}
		...
		\subsection{Recherche}
			\cvitemcom{Calculateur d'hyperplans dans des géométries finies de dimension 4 (orienté performances) [\Cpp{}]}
				{\href{https://github.com/Lomadriel/HyperplaneFinder}{HyperplaneFinder}}
			\cvitem{}{~~~> \textit{publication \cite{Boulmier2019}}}
		\subsection{Stages}
			\cvitemcom{Programme de résolution du Set Cover Problem [\Cpp{}, dynamic\_bitset, spglog, json, cxxopts]}
				{\href{https://github.com/pinam45/UTBM_ST50_Rapport_de_stage_IRIMAS/releases/latest}{Rapport de stage}}
			\cvitemcom{Programme de traitement des résultats du Set Cover Problem [\Cpp{}, spglog, json, cxxopts, inja]}
				{\href{https://github.com/pinam45/UTBM_ST50_Rapport_de_stage_IRIMAS/releases/latest}{Rapport de stage}}

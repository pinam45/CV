...
\firstname{Maxime}
\familyname{Pinard}
\title{Élève-ingénieur en 1ère année d'informatique, je cherche une mission d’assistant ingénieur pour automne 2017}
...
%-------------------------------------------
	...
	\section{Cursus}
		\tlcventry{2016}{0}{Diplôme d'ingénieur informatique, spécialité imagerie}{UTBM}{Belfort}{\textit{Bac+5}}{}
...
%-------------------------------------------
	...
	\section{Compétances informatiques}
		\subsection{Languages}
			\cvdoubleitem{Maitrisés}{C, C++, JAVA, \LaTeX ,HTML/CSS, Assembleur.}{Connus}{VBA, UPC, CUDA, PHP, SQL, VHDL.}
